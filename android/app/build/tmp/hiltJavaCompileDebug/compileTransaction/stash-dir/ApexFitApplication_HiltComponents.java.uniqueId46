...
import com.apexfit.core.config.di.ConfigModule;
...
public final class ApexFitApplication_HiltComponents {
  private ApexFitApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements ApexFitApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          StrainViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ...
          StrainViewModel_HiltModules.BindsModule.class,
